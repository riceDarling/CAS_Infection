...
<html>
	...
	<head>
		<meta charset="utf-8" />
		<title keywords="report">分学校实时统计</title>
				...
				<div class="bodyrightarea_xk white">
					<div class="bodybox">
						<div class="bodyrightcenter_xk">
							<div class="bodybox">
								<div class="cardTitle">分学校实时统计</div>
								<div class="cardBody">
											...
											<div class="mainlistbox_xk">
												<div class="bodybox scrolltable">
													<table class="mainlist_xk" border="0" cellspacing="0" cellpadding="0">
														<thead>
															<tr>
																<th rowspan="3"><div style="text-align: right;padding-right:15px;margin-bottom:30px;">疾病名称</div><div style="text-align: left;padding-left:15px;">学校分组</div></th>
																<th colspan="6">总计</th>
																<th colspan="6">痢疾</th>
