...
<head>
<meta charset="utf-8" />
<title keywords="report">编辑报告卡</title>
										...
										<table class="edittable" border="0" cellspacing="0" cellpadding="0">
											<tbody>
												...
												<tr>
													...
													<td class="secondtd"><select name="schoolId" id="editreport_school" nes="报告学校">
															<option value="">请选择</option>
													</select></td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="secondtd"><input type="text" name="idNumber" id="" value=""  nes="学籍号"/>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="secondtd"><input class="time_plugin_lv_onclick" time_plugin_lv_type="2" type="text" name="birthDay" id="editreport_birthDay"  value="" style="width:51% !important"/></td>
												</tr>
												<tr>
													<td class="firsttd">如生日不详，填实足年龄</td>
													<td class="secondtd"><input class="month_xk" type="text" name="age" id="editreport_age" nes="年龄"  value="" />岁</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="secondtd"><select name="" id="editreport_infectiontype" nes="传染病种类" >
															<option value="">请选择</option>
													</select></td>
												</tr>
												<tr>
													<td class="firsttd">传染病名称</td>
													<td class="secondtd" id="editreport_infectionname"></td>
												</tr>
												<tr>
													<td class="firsttd">病例类型</td>
													<td class="secondtd"><select name="type" id="editreport_type" nes="病例类型">
												...
												<tr>
													...
													<td class="secondtd"><input class="year_xk time_plugin_lv_onclick" time_plugin_lv_type="2" type="text" name="fillTime" id="" value="" style="width:51% !important" nes="填卡日期"/></td>
												</tr>
												<tr>
													...
													<span id="editreport_isInfectionnum" style=""><input type="text" style="width:45px" name="isInfectionnum">人</span>
													</td>
												</tr>
												<tr>
											...
											<tfoot>
												<tr>
													<td colspan="2"><input type="button" name="" id="editreport_from_addbtn" value="提交" /></td>
												</tr>
											</tfoot>
										</table>
										</form>
