...
<html>
	...
	<head>
		<meta charset="utf-8" />
		<title keywords="infectiontype">传染病种类详情</title>
				...
				<div class="bodyrightarea_xk white">
					<div class="bodybox">
						<div class="bodyrightcenter_xk">
							<div class="bodybox">
								<div class="cardTitle">传染病种类详情</div>
								<div class="cardBody">
									<div class="bodybox gray1">
										<div class="bodyrightmain_xk">
												<table class="edittable" border="0" cellspacing="0" cellpadding="0">
													<tbody>
														<tr><td class="firsttd">编号</td><td class="secondtd" id="detail_typeId"></td></tr>
														<tr><td class="firsttd">名称</td><td class="secondtd" id="detail_typeName"></td></tr>
													</tbody>
			...
			$(function() {
				...
				$.ajax({
					...
					success : function(data) {
						var result = data.t;
						$("#detail_typeId").text(result.typeId);
						$("#detail_typeName").text(result.typeName);
					}
