...
<html>
	...
	<head>
		<meta charset="utf-8" />
		<title keywords="infection">管理已有传染病</title>
		...
		<script type="text/javascript" src="js/infection.js"></script>
	</head>
				...
				<div class="bodyrightarea_xk white">
					<div class="bodybox">
						<div class="bodyrightcenter_xk">
							<div class="bodybox">
								<div class="cardTitle">管理已有传染病</div>
								<div class="cardBody">
									<div class="bodybox gray1">
										<div class="bodyrightmain_xk">
											<div class="bordergrp">
												<div class="bordergrpline">
													<label for="" style="display: inline-block;min-width:60px;margin-right:6px;">传染病种类</label>
													<select id="select_type" style="display:inline-block;width:100px;margin-right:6px;">
														<!-- <option value=""></option> -->
													</select>
													<label for="" style="display: inline-block;min-width:60px;margin-right:6px;">传染病名称</label>
													<input type="text" name="" id="infection_name" value="" style="width:96px;" />
											...
											<div class="mainlistbox_xk">
												<div class="bodybox scrolltable">
													<table class="mainlist_xk" border="0" cellspacing="0" cellpadding="0">
														...
														<tfoot>
															<tr>
																<td colspan="5"  id="infection_foot">
																	第1页 共10页 共100条
																</td>
															</tr>
															<tr class="YApage">
