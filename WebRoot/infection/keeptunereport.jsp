...
<script type="text/javascript" src="js/keeptunereport.js"></script>
			...
			<div class="bodyrightarea_xk white">
				<div class="bodybox">
					<div class="bodyrightcenter_xk">
						<div class="bodybox">
							<div class="cardTitle">报告卡(留调)</div>
							<div class="cardBody">
								<div class="bodybox gray1">
									<div class="bodyrightmain_xk">
									<form id="keeptunereport_from">
										<table class="edittable" border="0" cellspacing="0" cellpadding="0">
											<tbody>
												...
												<tr>
													...
													<td class="secondtd">
														...
														</div> <input type="hidden" name="keeptuneimg" value="" nes="留调资料"> <img src="img/zhaopian.png" style="width:100px;" alt="上传照片" class="task_publish_bon"> <label class="mws-form-label">&nbsp;</label>
											...
											<tfoot>
												<tr>
													<td colspan="2"><input type="button" name="" id="keeptunereport_from_addbtn" value="提交留调资料" /></td>
												</tr>
											</tfoot>
										</table>
										</form>
