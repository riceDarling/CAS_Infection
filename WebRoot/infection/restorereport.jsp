...
<script type="text/javascript" src="js/restorereport.js"></script>
			...
			<div class="bodyrightarea_xk white">
				<div class="bodybox">
					<div class="bodyrightcenter_xk">
						<div class="bodybox">
							<div class="cardTitle">报告卡(复课)</div>
							<div class="cardBody">
								<div class="bodybox gray1">
									<div class="bodyrightmain_xk">
									<form id="restorereport_from">
										<table class="edittable" border="0" cellspacing="0" cellpadding="0">
											<tbody>
												...
												<tr>
													...
													<td class="secondtd">
														...
														</div> <input type="hidden" name="restoreImg" value="" nes="复课证明"> <img src="img/zhaopian.png" style="width:100px;" alt="上传照片" class="task_publish_bon"> <label class="mws-form-label">&nbsp;</label>
											...
											<tfoot>
												<tr>
													<td colspan="2"><input type="button" name="" id="restorereport_from_addbtn" value="复课并申请结案" /></td>
												</tr>
											</tfoot>
										</table>
										</form>
