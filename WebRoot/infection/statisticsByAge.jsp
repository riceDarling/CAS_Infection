...
<head>
<meta charset="utf-8" />
<title keywords="report">分年龄统计</title>
...
<script type="text/javascript" src="js/statisticsByAge.js"></script>
</head>
			...
			<div class="bodyrightarea_xk white">
				<div class="bodybox">
					<div class="bodyrightcenter_xk">
						<div class="bodybox">
							<div class="cardTitle">分年龄统计</div>
							<div class="cardBody">
								<div class="bodybox gray1">
									<div class="bodyrightmain_xk">
										<div class="bordergrp">
											<form id="age_select_form">
													...
													<div class="bordergrpline">
														<span id="divide_user">
															...
															<label for="">学校名称</label> 
																<select name="schoolId"	id="report_school">
												...
												<div class="bordergrpline">
													...
													<input type="button" id="age_select_btn" value="查询" />
												</div>
											</form>
										</div>
													...
													<thead>
														<tr>
															<th rowspan="3"><div
																...
																<div style="text-align: left;padding-left:15px;">年龄分组</div></th>
															<th colspan="6">总计</th>
														</tr>
														<tr>
															<th colspan="3">发病数</th>
